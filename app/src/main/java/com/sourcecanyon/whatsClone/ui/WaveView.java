...
/**
 * Created by Abderrahim El imame on 5/6/18.
 *
...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#282F81B7");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3C2F81B7");
