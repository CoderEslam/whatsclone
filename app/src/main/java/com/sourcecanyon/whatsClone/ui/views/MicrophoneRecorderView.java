...
public class MicrophoneRecorderView extends FrameLayout implements View.OnTouchListener {
    ...
    public void onFinishInflate() {
        ...
        AppCompatImageView recordButtonFab = ViewUtil.findById(this, R.id.quick_audio_fab);
    ...
    public void cancelAction() {
        if (this.actionInProgress) {
            ...
            if (listener != null)
                listener.onRecordCanceled(this.floatingRecordButton.lastPositionX);
        }
    }
    ...
    private static class FloatingRecordButton {
        ...
        private final AppCompatImageView recordButtonFab;

        private float startPositionX;
        private float lastPositionX;

        public FloatingRecordButton(Context context, AppCompatImageView recordButtonFab) {
            this.recordButtonFab = recordButtonFab;
            this.recordButtonFab.getBackground().setColorFilter(context.getResources()
                            .getColor(R.color.colorRedDark),
