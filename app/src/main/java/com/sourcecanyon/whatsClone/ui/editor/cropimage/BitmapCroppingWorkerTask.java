...
package com.sourcecanyon.whatsClone.ui.editor.cropimage;
...
final class BitmapCroppingWorkerTask
  ...
  /** Use a WeakReference to ensure the AppCompatImageView can be garbage collected */
  ...
  /**
   * Once complete, see if AppCompatImageView is still around and set bitmap.
   *
