...
public class AttachmentLayout extends PopupWindow {
    ...
    private static final String TAG = AttachmentLayout.class.getSimpleName();

    private final @NonNull
    LoaderManager loaderManager;
    private final @NonNull
    RecentPhotoViewRail recentRail;
    private final @NonNull
    AppCompatImageView imageButton;
    private final @NonNull
    AppCompatImageView audioButton;
    private final @NonNull
    AppCompatImageView documentButton;
    private final @NonNull
    AppCompatImageView contactButton;
    private final @NonNull
    AppCompatImageView cameraButton;
    private final @NonNull
    AppCompatImageView locationButton;
    private final @NonNull
    AppCompatImageView gifButton;
    private final @NonNull
    ...
    public AttachmentLayout(@NonNull Context context, @NonNull LoaderManager loaderManager, @Nullable AttachmentClickedListener listener) {
        super(context);
        ...
        this.audioButton.setOnClickListener(new PropagatingClickListener(ADD_AUDIO));
