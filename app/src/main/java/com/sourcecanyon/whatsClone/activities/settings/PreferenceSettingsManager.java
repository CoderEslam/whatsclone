...
public class PreferenceSettingsManager {
    ...
    private static final Uri default_call_notifications_settings_tone = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_RINGTONE);
     ...
     * @return this is what method will return
     */
    public static Uri getDefault_calls_notifications_settings_tone(Context mContext) {
        return Uri.parse(preferenceSettingsManager(mContext).getString(mContext.getString(R.string.key_call_notifications_settings_tone), "" + default_call_notifications_settings_tone));
    }
     ...
     * @return this is what method will return
     */
    public static boolean getDefault_calls_notifications_settings_vibrate(Context mContext) {
        return preferenceSettingsManager(mContext).getBoolean(mContext.getString(R.string.key_call_notifications_settings_vibrate), true);
    }
