package com.sourcecanyon.whatsClone.helpers.permissions;
...
class PermissionsRequest {
    ...
    Runnable allGrantedListener;

    private final @Nullable
    Runnable anyDeniedListener;
    private final @Nullable
    Runnable anyPermanentlyDeniedListener;
    private final @Nullable
    Runnable anyResultListener;

    private final @Nullable
    Consumer<List<String>> someGrantedListener;
    private final @Nullable
    Consumer<List<String>> someDeniedListener;
    private final @Nullable
