package com.sourcecanyon.whatsClone.helpers.picker;
...
public class HeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (PickerHelper.isNull(topChild)) {
            return;
        }
        ...
        currentHeader.setPadding((int) (currentHeader.getPaddingLeft() - PickerHelper.convertPixelsToDp(5, context)),
        ...
        if (PickerHelper.isNull(childInContact)) {
