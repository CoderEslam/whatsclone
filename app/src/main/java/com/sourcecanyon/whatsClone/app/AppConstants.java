...
import static com.sourcecanyon.whatsClone.app.WhatsCloneApplication.getInstance;
...
public class AppConstants {
    ...
    public static final boolean CRASH_LYTICS = true;//this is crashlytics if you have an account on fabric.io but don't forget to change the key in the manifests file
